...
public class demo extends PlayOpMode {
    ...
    void intake(){
        d.intake(a, d.im, DcMotor.Direction.FORWARD, Speed2);
        d.intake1(x, y, d.screw, DcMotorSimple.Direction.FORWARD, 0.4);
    }
    ...
    protected void run(double dt) throws InterruptedException {
        ...
        lsx_lerped = JCLibs.lerp(lsx_lerped, lsx, 0.9);
        rsx_lerped = JCLibs.lerp(rsx_lerped, rsx, 0.9);
        lsy_lerped = JCLibs.lerp(lsy_lerped, lsy, 0.9);
        intake();
        SwitchCase();
        Shooter();
    }
